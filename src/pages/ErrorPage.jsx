...
const ErrorPage = () => {
  return (
    <section className="bg-white">
      <div className="max-w-7xl min-h-screen px-0 py-12 mx-auto lg:flex lg:items-center lg:gap-16">
        <div className="wf-ull lg:w-1/2">
          ...
          <div className="flex items-center mt-6 gap-x-3">
            ...
            <Link
              to="/"
              className="w-1/2 px-5 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 bg-gray-500 rounded-lg shrink-0 sm:w-auto hover:bg-gray-600"
            >
              Take me home
            </Link>
          </div>
